	                ...
	                <div class="col-md-6 ml-auto mr-auto">
        	           <div class="profile">
                            ...
                            <h3 class="title">{{ Auth::user()->name }}</h3>                                  
                                <a href="{{ route('profil.edit') }}" class="button">Edit Profil</a>

                                <a href="{{ route('logout') }}" class="butto"
        ...
        <div class="col-md-6 ml-auto mr-auto">
            <form action="process_form.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control" placeholder="{{ Auth::user()->phone }}" >
                </div>
                <div class="form-group">
