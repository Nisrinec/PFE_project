...
<body>
    <div class="container mt-5">
        ...
        <form id="edit-post-form" action="{{ route('settings.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        ...
        <a href="{{ url('/settings/showpost') }}" class="btn btn-secondary mt-3">Back to Posts</a>
    </div>
